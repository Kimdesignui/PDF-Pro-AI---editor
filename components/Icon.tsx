...
export type IconType = 'rotate' | 'split' | 'split-page' | 'compress' | 'password' | 'signature' | 'insert-image' | 'ocr' | 'tts' | 'upload' | 'logo' | 'close' | 'merge' | 'trash' | 'file' | 'download' | 'check' | 'copy' | 'eye' | 'zoom-in' | 'rotate-left' | 'rotate-right';
